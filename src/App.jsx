...
function App() {
  ...
  const content1 = (
    <div className='absolute flex flex-col items-center top-1/2 left-1/2 -translate-1/2'>
      ...
      <button onClick={() => { window.scrollBy({ top: window.innerHeight, behavior: "smooth" }); }} className='icon-forward-down' aria-label='down icon'></button>
    </div>
  );
  // appointment store
  const content2 = (
    <div className='w-1/3 absolute top-1/2 left-1/2 -translate-1/2 bg-white p-[3%] flex flex-col items-center text-center'>
      ...
      <div className='w-auto'><button className="btn-style2 uppercase lg:text-sm text-xs text-white p-1" aria-label='book appointment' style={{ backgroundColor: "rgb(77,21,45)" }}>Book an In-store Appointment</button></div>
  ...
  const content3 = (
    <div className='lg:w-1/3 w-auto md:absolute top-1/2 left-1/2 md:-translate-1/2 bg-white p-[3%] flex flex-col items-center text-center'>
      ...
      <div className='w-3/4 mt-[5%]'><button className="btn-style2 uppercase text-sm text-white" aria-label='learn more' style={{ backgroundColor: "rgb(77,21,45)" }}>Learn More</button></div>
    </div>
  );
  // Reviews
  const content4 = (
  ...
  const contentm1 = (
    <div className='w-full flex flex-col items-center mt-8'>
      ...
      <button onClick={() => { window.scrollBy({ top: window.innerHeight, behavior: "smooth" }); }} className='icon-forward rotate-90' aria-label='forward'></button>
    </div>
  );
