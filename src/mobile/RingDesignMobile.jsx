  ...
  return (
    <section className='my-16'>
        ...
        <div className='flex flex-col items-center text-center px-8 py-20'>
            ...
            <div className='w-80'><button className='btn-style2 btn2 uppercase text-sm mb-2' aria-label='start setting'>Start with a setting</button></div>
            <div className="w-80 group flex flex-col items-center text-sm">
                <button onClick={()=>setShow(!show)} className='btn-style2 btn2 uppercase flex justify-center items-center gap-3' aria-label='start with diamond'>Start with a Diamond <span className={`down-btn-icon lg:group-hover:rotate-180 ${show?'rotate-180':''}`}></span></button>
                <div className={`${show?'block':'hidden'} w-full lg:group-hover:block mt-2`}>
                    <button className='block btn-style2 btn2' aria-label='lab'>LAB</button>
                    <button className='block btn-style2 btn2 my-0.5' aria-label='natural'>NATURAL</button>
                    <button className='block btn-style2 btn2' aria-label='lab colored'>LAB COLORED</button>
                </div>
            </div>
        </div>
